    ...
    <>
      <div style={{ textAlign: 'center', display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
        ...
        <div className="text-frontground-3" style={{ maxWidth: '60ch', paddingTop: '1rem' }}>
          <Text size="md">
            A productivity tool for software developers. It helps developers track the amount of time they spend on coding projects, and provides insights into their coding habits and productivity.
          </Text>
        </div>
        <Btn border size="lg" style={{ marginTop: '3rem' }} onClick={() => { window.location.href = `${import.meta.env.VITE_API_BASE_URL}/auth/github` }}>

...
export function AwesomeText ({ children, colorStart, colorEnd }: { children?: ReactNode, colorStart: string, colorEnd: string }) {
  ...
  return (
    <div
      className="gradient-text monospace"
      style={{
    ...
    <>
      <div style={{ textAlign: 'center', display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
        ...
        <Btn
          ...
          onClick={() => { window.location.href = `${baseURL}/auth/github?redirect=${window.location.origin}/dashboard` }}
        >
          <div style={{ display: 'flex', alignItems: 'center', padding: '0.2rem' }}>
            ...
            <span style={{ marginLeft: '0.5rem', fontSize: '1rem' }}>{ t('signInGithub') }</span>
          </div>
        </Btn>
        <div
          className="text-frontground-3 text-xs"
          style={{
            marginTop: '1rem',
          }}
        >

...
export function PrivacyPolicy () {
  return <Article>
    ...
    <ul>
      ...
      <li>
        <p><strong>{ 'Company' }</strong>{ ' (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to CodeTime.' }</p>
      </li>
      <li>
      ...
      <li>
        <p><strong>{ 'Website' }</strong>{ ' refers to CodeTime, accessible from ' }<a href="https://codetime.dev" rel="external nofollow noopener noreferrer" target="_blank">{ 'https://codetime.dev' }</a></p>
      </li>
      <li>
    ...
    <ul>
      <li>
        <p>{ 'By email: jannchie@gmail.com' }</p>
      </li>
      <li>
        <p>{ 'By visiting this page on our website: ' }<a href="https://codetime.dev/contact" rel="external nofollow noopener noreferrer" target="_blank">{ 'https://codetime.dev/contact' }</a></p>
      </li>
    </ul>
  </Article>
}
